...
class DouBanBook(models.Model):
    ...
    title = models.CharField(default='', max_length=128, blank=True,
                             null=True, verbose_name='图书书名')
    url = models.URLField(default='', max_length=256, blank=True,
                          null=True, verbose_name='图书地址')
    author_intro = models.TextField(default='', blank=True,
                                    null=True, verbose_name='作者简介')
    summary = models.TextField(default='', blank=True,
                               null=True, verbose_name='内容简介')
    price = models.CharField(default=0, max_length=128, blank=True,
                             null=True, verbose_name='定价')
    ebook_price = models.CharField(default=0, max_length=128, blank=True,
                                   null=True, verbose_name='电子书定价')
